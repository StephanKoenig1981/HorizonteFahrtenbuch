...
class contactsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        /*if realm.objects(clients.self).count < 1 {
            let alert = UIAlertController(title: "GPS Zugriff verweigert", message: "Du hast noch keine Kundendaten gespeichert", preferredStyle: .alert)
